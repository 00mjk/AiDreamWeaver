    ...
    return <>
        <fieldset className="create-fieldset">
            ...
            <div id="slider-undefined" className="flex items-center gap-x-4 slider-container">
                ...
                />
                <input type="text" className="w-12 rounded-full bg-gray-90 text-xs text-center py-1 text-gray-200 " value={props.value} onChange={(e) => props.onChange(e.target.value)} />
            </div>
        </fieldset>
    </>
}
